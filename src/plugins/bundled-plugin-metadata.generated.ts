...
export const GENERATED_BUNDLED_PLUGIN_METADATA = [
  ...
  {
    dirName: "whatsapp-passive-monitor",
    idHint: "whatsapp-passive-monitor",
    source: {
      source: "./index.ts",
      built: "index.js",
    },
    packageName: "@openclaw/whatsapp-passive-monitor",
    packageVersion: "2026.2.23",
    packageDescription: "Passively monitors WhatsApp messages via local LLM classification",
    packageManifest: {
      extensions: ["./index.ts"],
    },
    manifest: {
      ...
      description:
        "Intercepts WhatsApp messages via message_observed hook (pre-access-control), stores in SQLite, and classifies via local LLM. Returns { handled: true } to block agent dispatch.",
      uiHints: {
        ollamaUrl: {
          label: "Ollama URL",
        ...
        detectMeetings: {
          ...
          help: "Enable LLM-based meeting detection pipeline (default: true). When false, messages are stored but not classified.",
        },
      },
    },
  },
